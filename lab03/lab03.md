...
#### Демонстрация работы
Для запуска перейти в дирекотрию lab03_A:
```bash
cd lab03/lab03_A/
```

После чего исполнить:
```bash
go run cmd/ws_server/main.go --server_port 9000
```
Существующий файл:
![img.png](img.png)
Несуществующий файл:
...
Демонстрация:
Для запуска перейти в дирекотрию lab03_B:
```bash
cd lab03/lab03_B/
```
...
#### Демонстрация работы
Для запуска перейти в дирекотрию lab03_С:
```bash
cd lab03/lab03_C/
```
...
После чего исполнить (запустить клиент):
```bash
